...
void parseHeaders32( header& _text, header& _data, header& _ronly, header& _bss,
	header& _symtab,
	header& _dynsym,
	header& _strtab,
	header& _dynstr,
	...
	header& _got,
	header& _rel,
	header& _eh_frame, AddressSpace& data, uint32_t e_shoff, uint16_t e_shentsize, uint16_t e_shnum, uint16_t e_shstrndx) {
 ...
 void setHeaders32bit(header& _text, header& _data, header& _ronly, header& _bss,
	...
	parseHeaders32(_text, _data, _ronly, _bss, _symtab, _dynsym, _strtab, _dynstr, _plt, _got, _rel, _eh_frame, data, e_shoff, e_shentsize, e_shnum, e_shstrndx);
 ...
 void setHeaders32bitARM(header& _text, header& _data, header& _ronly, header& _bss,
	 ...
	 throw std::runtime_error("ARM32 support not implemented yet.");
