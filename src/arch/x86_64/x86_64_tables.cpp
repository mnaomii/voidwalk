...
constexpr std::array<Instruction::OpcodeInfo, 256> buildOpcodes() {
...
constexpr std::array<Instruction::OpcodeInfo, 8> buildGroup1() {
...
constexpr std::array<Instruction::OpcodeInfo, 8> buildGroup2() {
	std::array<Instruction::OpcodeInfo, 8> n{};
	GT(0, "ROL", 2);
	GT(1, "ROR", 2);
	GT(2, "RCL", 2);
...
constexpr std::array<Instruction::OpcodeInfo, 8> buildGroup3() {
	std::array<Instruction::OpcodeInfo, 8> n{};
...
constexpr std::array<Instruction::OpcodeInfo, 8> buildGroup4() {
	std::array<Instruction::OpcodeInfo, 8> n{};
...
constexpr std::array<Instruction::OpcodeInfo, 8> buildGroup5() {
	std::array<Instruction::OpcodeInfo, 8> n{};
...
constexpr std::array<Instruction::OpcodeInfo, 64> buildX87Mem() {
...
constexpr std::array<Instruction::OpcodeInfo, 512> buildX87Reg() {
...
constexpr std::array<Instruction::OpcodeInfo, 256> buildTwoByteOpcodes() {
	std::array<Instruction::OpcodeInfo, 256> n{};
...
constexpr std::array<Instruction::OpcodeInfo, 8> buildTwoByteGroup8() {
	std::array<Instruction::OpcodeInfo, 8> n{};
#define a(name) static_cast<uint8_t>(ADDRESSING::name)
#define s(name) static_cast<uint8_t>(SIZE::name)
#define OP(mode,sz,val,val16) Instruction::TableOperand{ a(mode), s(sz), false, val, val, val16 }
...
const std::array<Instruction::OpcodeInfo, 256>& x86_64_Mnemonic::opcodeTable() {
	static constexpr std::array<Instruction::OpcodeInfo, 256> t = buildOpcodes();
	return t;
}

const std::array<Instruction::OpcodeInfo, 8>& x86_64_Mnemonic::grp1Table() {
	static constexpr std::array<Instruction::OpcodeInfo, 8> t = buildGroup1();
	return t;
}

const std::array<Instruction::OpcodeInfo, 8>& x86_64_Mnemonic::grp2Table() {
	static constexpr std::array<Instruction::OpcodeInfo, 8> t = buildGroup2();
	return t;
}

const std::array<Instruction::OpcodeInfo, 8>& x86_64_Mnemonic::grp3Table() {
	static constexpr std::array<Instruction::OpcodeInfo, 8> t = buildGroup3();
	return t;
}

const std::array<Instruction::OpcodeInfo, 8>& x86_64_Mnemonic::grp4Table() {
	static constexpr std::array<Instruction::OpcodeInfo, 8> t = buildGroup4();
	return t;
}

const std::array<Instruction::OpcodeInfo, 8>& x86_64_Mnemonic::grp5Table() {
	static constexpr std::array<Instruction::OpcodeInfo, 8> t = buildGroup5();
	return t;
}

const std::array<Instruction::OpcodeInfo, 8>& x86_64_Mnemonic::groupTableOf(uint32_t op) {
	switch (groupNoOf(op)) {
...
const Instruction::OpcodeInfo& x86_64_Mnemonic::groupEntryOf(uint32_t op, uint8_t reg) {
	return groupTableOf(op)[reg & 0x07];
}

const std::array<Instruction::OpcodeInfo, 64>& x86_64_Mnemonic::x87MemTable() {
	static constexpr std::array<Instruction::OpcodeInfo, 64> t = buildX87Mem();
	return t;
}

const std::array<Instruction::OpcodeInfo, 512>& x86_64_Mnemonic::x87RegTable() {
	static constexpr std::array<Instruction::OpcodeInfo, 512> t = buildX87Reg();
	return t;
}

Instruction::OpcodeInfo x86_64_Mnemonic::x87ResolvedInfo(uint32_t op, uint8_t modrm) {
...
Instruction::OpcodeInfo x86_64_Mnemonic::resolvedInfo(uint32_t op, uint8_t modrm, bool is64Bit) {
	...
	constexpr uint8_t immMode = static_cast<uint8_t>(ADDRESSING::I);
	constexpr uint8_t v = static_cast<uint8_t>(SIZE::v);
	constexpr uint8_t z = static_cast<uint8_t>(SIZE::z);
	...
	auto take = [&](const Instruction::TableOperand& e, Instruction::TableOperand& dst) {
		...
		dst.size    = (e.size != none) ? e.size
		            : (e.addressingMode == immMode && opSize == v) ? z : opSize;
...
const Instruction::OpcodeInfo& x86_64_Mnemonic::threeByteRow(bool hasImm8) {
...
const std::array<Instruction::OpcodeInfo, 256>& x86_64_Mnemonic::twoByteTable() {
	static constexpr std::array<Instruction::OpcodeInfo, 256> t = buildTwoByteOpcodes();
	return t;
}

const std::array<Instruction::OpcodeInfo, 8>& x86_64_Mnemonic::twoByteGroup8Table() {
	static constexpr std::array<Instruction::OpcodeInfo, 8> t = buildTwoByteGroup8();
	return t;
}

const std::array<Instruction::OpcodeInfo, 8>& x86_64_Mnemonic::twoByteGroupTableOf(uint32_t op2) {
...
Instruction::OpcodeInfo x86_64_Mnemonic::twoByteResolvedInfo(uint32_t op2, uint8_t modrm) {
	const uint8_t reg = (modrm >> 3) & 0x07;
