...
#include "tests/framework/isolate.hpp"
...
// AsyncDecode_Tests's constructor, and the shared Tests counters aggregate the results.
void run_async_decode_tests() { AsyncDecode_Tests t; }
